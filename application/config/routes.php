...
$route['get_sizes']   = 'Administrator/Page/getSizes';
$route['add_size']    = 'Administrator/Page/addSize';
$route['save_size']   = 'Administrator/Page/saveSize';
$route['update_size'] = 'Administrator/Page/updateSize';
$route['delete_size'] = 'Administrator/page/deleteSize';

$route['get_companies']  = 'Administrator/Page/getCompanies';
$route['company']        = 'Administrator/Page/add_Company';
$route['save_company']   = 'Administrator/Page/saveCompany';
$route['update_company']   = 'Administrator/Page/updateCompany';
$route['delete_company'] = 'Administrator/page/delete_company';
...
$route['get_product_sizes']              = 'Administrator/Products/getProductSizes';
$route['get_size_wise_stock']            = 'Administrator/Products/getSizewiseStock';
...
$route['productReturn']         = 'Administrator/Sales/productReturn';
$route['add_product_return']    = 'Administrator/Sales/addProductReturn';
$route['update_product_return'] = 'Administrator/Sales/updateProductReturn';
$route['get_product_return']    = 'Administrator/Sales/getProductReturn';
$route['delete_product_return'] = 'Administrator/Sales/deleteProductReturn';
$route['product_return_list']   = 'Administrator/Sales/productReturnList';
