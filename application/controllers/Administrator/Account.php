...
class Account extends CI_Controller
{
    ...
    public function getCashLedger()
    {
        ...
        $ledger = $this->db->query("
            ...
            select 
                pr.ProductReturn_SlNo as id,
                pr.ReturnDate as date,
                'Product return Amount' as description,
                0.00 as in_amount,
                pr.ReturnAmount as out_amount
            from tbl_productreturn pr
            where pr.brunchId = '$this->brunch'
            and pr.Status = 'a'
            and pr.ReturnDate between '$data->fromDate' and '$data->toDate'
