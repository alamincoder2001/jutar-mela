...
<div class="row" id="customerPaymentReport">
	<div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;">
		<div class="form-group">
			<label class="col-sm-1 control-label no-padding-right"> ক্রেতা </label>
			<div class="col-sm-2">
		...
		<div class="form-group">
			<label class="col-sm-1 control-label no-padding-right">তারিখ হতে </label>
			<div class="col-sm-2">
				<input type="date" class="form-control" v-model="dateFrom">
			</div>
			<label class="col-sm-1 control-label no-padding-right text-center" style="width:30px"> থেকে </label>
			<div class="col-sm-2">
		...
		<div class="form-group">
			<div class="col-sm-1">
				<input type="button" class="btn btn-primary" value="দেখুন" v-on:click="getReport" style="margin-top:0px;border:0px;height:28px;">
			</div>
		</div>
	</div>
			...
			<table class="table table-bordered">
				<thead>
					<tr>
						...
						<th style="text-align:center">বিল</th>
						<th style="text-align:center">পরিশধ</th>
						<th style="text-align:center">চালান বাকি</th>
						<th style="text-align:center">ফেরত</th>
						<th style="text-align:center">গ্রাহক হতে প্রাপ্তি</th>
						<th style="text-align:center">ব্যালেন্স</th>
					</tr>
				</thead>
				<tbody>
					<tr>
						<td></td>
						<td style="text-align:left;">পূর্বের ব্যালেন্স</td>
						<td colspan="5"></td>
				...
				<tbody v-if="payments.length == 0">
					<tr>
						<td colspan="8">কোন রেকর্ড পাওয়া যায়নি</td>
					</tr>
				</tbody>
			</table>
		</div>
