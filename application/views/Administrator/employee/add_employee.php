<?php /*   $serial ="E1000"; $sql = $this->db->query("SELECT * FROM tbl_employee");
...
<div class="row">
	...
	<div class="form-horizontal">
		<br/>
		<div class="col-sm-6">
			<div class="col-sm-12 align-center"> <strong>জব তথ্য</strong></div>
		<hr/>
		<div class="form-group">
			<label class="col-sm-4 control-label" for="Product_id"> কর্মচারী আইডি </label>
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-2">
				<input type="text" name="Employeer_id" id="Employeer_id" value="<?php echo $generateCode; ?>" class="form-control" readonly />
			</div>
			
			<label class="col-sm-2 control-label" for="bio_id"> বায়ো আইডি: </label>
			<div class="col-sm-2">
		...
		<div class="form-group">
			<label class="col-sm-4 control-label" for="em_name"> কর্মকর্তার নাম </label>
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
		...
		<div class="form-group">
			<label class="col-sm-4 control-label" for="em_Designation"> উপাধি </label>
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-5">
		...
		<div class="form-group">
			<label class="col-sm-4 control-label" for="em_Depertment"> ডিপার্টমেন্ট </label>
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-5">
			...
			<div class="form-group">
			<label class="col-sm-4 control-label" for="em_Joint_date">যৌথ তারিখ</label>
			<label class="col-sm-1 control-label">:</label>
				<div class="col-sm-6">
		...
		<div class="form-group">
			<label class="col-sm-4 control-label" for="salary_range">বেতন পরিসীমা</label>
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
		...
		<div class="form-group">
			<label class="col-sm-4 control-label" for="form-field-1"> সক্রিয়করণ স্ট্যাটাস</label>
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
		...
		<div class="col-sm-6">
		<div class="col-sm-12 align-center"> <strong>যোগাযোগের তথ্য</strong></div>

		<hr/>
		<div class="form-group">
			<label class="col-sm-4 control-label" for="em_Present_address"> বর্তমান ঠিকানা </label>
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
		...
		<div class="form-group">
			<label class="col-sm-4 control-label" for="em_Permanent_address"> স্থায়ী ঠিকানা </label>
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
		...
		<div class="form-group">
			<label class="col-sm-4 control-label" for="em_contact"> যোগাযোগের নম্বর </label>
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
		...
		<div class="form-group">
			<label class="col-sm-4 control-label" for="ec_email">ই-মেইল </label>
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
		...
		<div class="form-group">
			<label class="col-sm-4 control-label" for="em_photo"> কর্মচারী ছবি </label>
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
		...
		<div class="form-group">
			<label class="col-sm-4 control-label" for="em_photo"> রেফারেন্স </label>
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
...
<div class="row">
	<div class="form-horizontal">
			<br/>
		<div class="col-sm-6">
		<div class="col-sm-12 align-center"> <strong>ব্যক্তিগত তথ্য</strong></div>
		<hr/>
			<div class="form-group">
				<label class="col-sm-4 control-label" for="form-field-1"> বাবার নাম </label>
				<label class="col-sm-1 control-label">:</label>
				<div class="col-sm-6">
		...
		<div class="form-group">
			<label class="col-sm-4 control-label" for="form-field-1">মায়ের নাম</label>
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
		...
		<div class="form-group">
			<label class="col-sm-4 control-label" for="form-field-1"> লিঙ্গ </label>
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
		...
		<div class="form-group">
			<label class="col-sm-4 control-label" for="em_dob">জন্ম তারিখ</label>
			<label class="col-sm-1 control-label">:</label>
				<div class="col-sm-6">
		...
		<div class="form-group">
			<label class="col-sm-4 control-label" for="Marital"> বৈবাহিক অবস্থা </label>
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
