		...
		<div class="col-md-12">
			<form class="form-inline" @submit.prevent="getEmployees">
				...
				<div class="form-group">
					<label class="col-sm-4 control-label no-padding-right"> মাস </label>
					<div class="col-sm-7">
				...
				<div class="form-group" style="margin-top: -5px;">
					<input type="submit" class="search-button" value="দেখুন">
				</div>
			</form>
		</div>
	</div>
		...
		<div class="col-md-12">
			...
			<div class="table-responsive">
				<table class="table table-bordered">
					...
					<tfoot>
						<tr>
							<td colspan="9" style="text-align: right;">মোট =</td>
