				...
				<table 
					...
					<tbody>
						<template v-for="payment in payments">
							<tr>
								<td colspan="8" style="font-size:13px;text-align:center; background: orange;"> <strong>মাস :</strong> {{ payment.month_name }} || <strong>প্রদানের তারিখ:</strong> {{ payment.payment_date }} || <strong>Payment By:</strong> {{ payment.User_Name }} || <strong>মোট টাকা:</strong> {{ payment.total_payment_amount }}</td>
							</tr>
					...
					<table class="record-table">
						<thead>
							<tr>
								...
								<th>পেমেন্ট তারিখ</th>
								<th>বেতন</th>
								<th>ওভারটাইম / অন্যান্য সুবিধা</th>
								<th>কর্তন</th>
								<th>নেট প্রদেয়</th>
								<th>পেমেন্ট</th>
								<th>মন্তব্য করুন</th>
