...
<?php $sql = mysql_query("SELECT * FROM tbl_menuaccess WHERE branch_id = '3'");
$row = mysql_fetch_array($sql); ?>
    <h1 style="background:#ddd;" align="center">Sylhet Branch</h1>
    <form action="<?php echo base_url() ?>Administrator/branch/Sylhet_Insert" method="post">
    <input type="hidden" name="brid" value="3">
        <div class="tabContent" style="width:30%;float:left; border: 1px solid #ddd;">
            <ul id="brunch_menu">
        ...
        <h3>Reports</h3>
            <ul id="brunch_menu">
                ...
                <li><INPUT TYPE="CHECKBOX" <?php if($row['rpSales']==1)echo "checked";?> value="<?php echo $row['rpSales'];?>" id="RSales" NAME="RSales">Sales
                    <ul id="brunch_menu">
                        <li><INPUT TYPE="CHECKBOX" <?php if($row['Sales_Invoice']==1)echo "checked";?> value="<?php echo $row['Sales_Invoice'];?>" id="SalesInvoice" NAME="SalesInvoice">বিক্রয় ভাউচার</li>
