		...
		<div class="col-sm-6 col-sm-offset-3">
			<?php if ($selected) { ?>
				<form class="form-vertical" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>company_profile_Update">
					<div class="form-group">
						<label class="control-label" for="">প্রতিষ্ঠান লোগো</label>
						<div class="col-sm-12">
							<div class="left">
					...
					<div class="form-group">
						<label class="control-label" for="companyLogo">লোগো পরিবর্তন করুন</label>
						<div>
					...
					<div class="form-group" style="margin-top:15px">
						<label class="control-label" for="form-field-1"> প্রতিষ্ঠানের নাম</label>
						<div>
					...
					<div class="form-group" style="margin-top:15px">
						<label class="control-label" for="form-field-1"> বর্ণনা </label>
						<div>
							<textarea id="Description" name="Description" class="form-control"><?php echo $selected->Repot_Heading; ?></textarea>
						</div>
					</div>
					<div class="form-group" style="margin-top:15px">
						<label class="control-label" for="form-field-1"> চালান নোট </label>
						<div>
							<textarea id="invoice_note" name="invoice_note" class="form-control"><?php echo $selected->invoice_note; ?></textarea>
						</div>
					</div>

					<div class="control-group" style="margin-top:15px;">
						<label class="col-sm-12 control-label bolder blue">চালান প্রিন্টের ধরন</label>
			...
			?>
				...
				<form method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>company_profile_insert">
					<div class="form-group">
						<label class="col-sm-12 control-label" for="pro_Name">প্রতিষ্ঠানের লোগো</label>
						<div class="col-sm-12">
					...
					<!-- <div class="form-group"> -->
					<label class="col-sm-12 control-label" for="pro_Name">লোগো পরিবর্তন করুন</label>
					<!-- <div class="col-sm-12"> -->
					...
					<div class="form-group">
						<label class="col-sm-12 control-label" for="form-field-1" style="margin-top:15px;"> প্রতিষ্ঠানের নাম </label>
						<div class="col-sm-12">
					...
					<div class="form-group">
						<label class="control-label" for="form-field-1" style="margin-top:15px;"> বর্ণনা </label>
						<div>
				...
				<div class="row" style="margin-top: 15px;">
					<div class="col-md-12">
						<form class="form-horizontal" @submit.prevent="saveBranch">
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right"> শাখার নাম </label>
							...
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right"> শাখার শিরোনাম </label>
								<label class="col-sm-1 control-label no-padding-right">:</label>
								<div class="col-sm-8">
							...
							<div class="form-group"> 
								<label class="col-sm-3 control-label no-padding-right"> শাখার ঠিকানা </label>
								<label class="col-sm-1 control-label no-padding-right">:</label>
								<div class="col-sm-8">
