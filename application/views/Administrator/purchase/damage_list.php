...
<div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;">
		<div class="form-group" style="margin-top:10px;">
			<label class="col-sm-1 col-sm-offset-2 control-label no-padding-right" for="searchtype"> সার্চ টাইপ </label>
			<div class="col-sm-3">
	...
	<div class="form-group">
		<div class="col-sm-1">
			<input type="button" class="btn btn-primary" onclick="searchforRecord()" value="রিপোর্ট দেখুন" style="margin-top:0px;border:0px;height:28px;">
		</div>
	</div>
</div>
