	...
	<div class="col-xs-12 col-md-9 col-lg-9">
		<div class="widget-box">
			<div class="widget-header">
				<h4 class="widget-title">সরবরাহকারী এবং পণ্য তথ্য</h4>
			...
			<div class="widget-body">
				<div class="widget-main">
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								<label class="col-xs-4 control-label no-padding-right"> সরবরাহকারী </label>
								<div class="col-xs-7">
							...
							<div class="form-group" style="display:none;" v-bind:style="{display: selectedSupplier.Supplier_Type == 'G' ? '' : 'none'}">
								<label class="col-xs-4 control-label no-padding-right"> নাম </label>
								<div class="col-xs-8">
							...
							<div class="form-group">
								<label class="col-xs-4 control-label no-padding-right"> মোবাইল নং </label>
								<div class="col-xs-8">
							...
							<div class="form-group">
								<label class="col-xs-4 control-label no-padding-right"> ঠিকানা </label>
								<div class="col-xs-8">
						...
						<div class="col-sm-6">
							<form v-on:submit.prevent="addToCart">
								<div class="form-group">
									<label class="col-xs-4 control-label no-padding-right"> পণ্যের নাম </label>
									<div class="col-xs-7">
								...
								<div class="form-group">
									<label class="col-xs-4 control-label no-padding-right"> পণ্যের সাইজ </label>
									<div class="col-xs-8">
										<input type="text" v-model="selectedProduct.product_size" class="form-control" placeholder="Size name" />
									</div>
								</div>
								...
								<div class="form-group">
									<label class="col-xs-4 control-label no-padding-right"> ক্রয়ের দর </label>
									<div class="col-xs-3">
									...
									<label class="col-xs-2 control-label no-padding-right"> পরিমাণ </label>
									<div class="col-xs-3">
								...
								<div class="form-group">
									<label class="col-xs-4 control-label no-padding-right"> সর্বমোট টাকা </label>
									<div class="col-xs-8">
								...
								<div class="form-group">
									<label class="col-xs-4 control-label no-padding-right"> বিক্রয়ের দর </label>
									<div class="col-xs-8">
				...
				<table class="table table-bordered" style="color:#000;margin-bottom: 5px;">
					<thead>
						<tr>
							...
							<th style="width:20%;color:#000;">পণ্যের নাম</th>
							<th style="width:20%;color:#000;">পণ্যের সাইজ</th>
							<th style="width:13%;color:#000;">শ্রেনী</th>
							<th style="width:8%;color:#000;">ক্রয়ের দর</th>
							<th style="width:5%;color:#000;">পরিমাণ</th>
							<th style="width:13%;color:#000;">সর্বমোট টাকা</th>
							...
							<div class="table-responsive">
								<table style="color:#000;margin-bottom: 0px;">
									<tr>
										<td>
											<div class="form-group">
												<label class="col-xs-12 control-label no-padding-right">মোট টাকা</label>
												<div class="col-xs-12">
									...
									<tr>
										<td>
											<div class="form-group">
												<label class="col-xs-12 control-label no-padding-right"> ভ্যাট </label>
												<div class="col-xs-12">
									...
									<tr>
										<td>
											<div class="form-group">
												<label class="col-xs-12 control-label no-padding-right">ছাড়</label>
												<div class="col-xs-12">
									...
									<tr>
										<td>
											<div class="form-group">
												<label class="col-xs-12 control-label no-padding-right">পরিবহণ/শ্রমিক খরচ</label>
												<div class="col-xs-12">
									...
									<tr>
										<td>
											<div class="form-group">
												<label class="col-xs-12 control-label no-padding-right">সর্বমোট টাকা</label>
												<div class="col-xs-12">
									...
									<tr>
										<td>
											<div class="form-group">
												<label class="col-xs-12 control-label no-padding-right">নগদ প্রদান</label>
												<div class="col-xs-12">
									...
									<tr>
										<td>
											<div class="form-group">
												<label class="col-xs-12 control-label no-padding-right">পূর্বের বকেয়া</label>
												<div class="col-xs-12">
									...
									<tr>
										<td>
											<div class="form-group">
												<label class="col-xs-12 control-label no-padding-right">বকেয়া</label>
												<div class="col-xs-6">
									...
									<tr>
										<td>
											<div class="form-group">
												<div class="col-xs-6">
													<input type="button" class="btn btn-success" value="ক্রয়" v-on:click="savePurchase" v-bind:disabled="purchaseOnProgress == true ? true : false" style="background:#000;color:#fff;padding:3px;width:100%;">
												</div>
												<div class="col-xs-6">
													<input type="button" class="btn btn-info" onclick="window.location = '<?php echo base_url(); ?>purchase'" value="নতুন ক্রয়" style="background:#000;color:#fff;padding:3px;width:100%;">
												</div>
											</div>
										</td>
									</tr>
		...
		methods: {
			...
			getProducts() {
				axios.post('/get_products', {
					...
					this.products.map(p => p.product_size = '');
				})
			},
			onChangeSupplier() {
			...
			addToCart() {
				let cartInd = this.cart.findIndex(p => p.productId == this.selectedProduct.Product_SlNo && p.product_size == this.selectedProduct.product_size);
				if (cartInd > -1) {
					alert('Product exists in cart');
					return;
				}

				if (this.selectedProduct.product_size == '') {
				...
				let product = {
					...
					product_size: this.selectedProduct.product_size,
