...
<div id="bankTransactions">
    <div class="widget-box">
        <div class="widget-header">
            <h4 class="widget-title">লেনদেন</h4>
                        ...
                        <form action="" class="form-horizontal" @submit.prevent="saveTransaction">
                            ...
                            <div class="form-group">
                                <div class="col-md-8 col-md-offset-4">
                                    <input type="submit" value="লেনদেন সেইভ" v-bind:disabled="onProgress ? true : false" class="btn btn-success btn-xs">
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    new Vue({
        ...
        data(){
            return {
                ...
                columns: [
                    ...
                    { label: 'লেনদেন প্রকার', field: 'transaction_type', align: 'center' },
        ...
        methods: {
            ...
            getTransactions(){
                ...
                axios.post('/get_bank_transactions', data)
                .then(res => {
            ...
            saveTransaction(){
                ...
                let url = '/add_bank_transaction';
                if(this.transaction.transaction_id != 0){
                    url = '/update_bank_transaction';
                }
            ...
            removeTransaction(transaction){
                ...
                axios.post('/remove_bank_transaction', transaction)
                .then(res => {
                    let r =  res.data;
                    alert(r.message);
                    if(r.success){
            ...
            getBankBalance(){
                ...
                axios.post('/get_bank_balance', {accountId: this.selectedAccount.account_id}).then(res => {
