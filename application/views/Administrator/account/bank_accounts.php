...
<div id="bankAccounts">
    <div class="widget-box">
        <div class="widget-header">
            <h4 class="widget-title">হিসাবের তথ্য</h4>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-md-offset-2">
                            <div class="form-group">
                                <label for="" class="control-label col-md-4">হিসাবের নাম</label>
                                <div class="col-md-8">
                            ...
                            <div class="form-group">
                                <label for="" class="control-label col-md-4">হিসাব নং</label>
                                <div class="col-md-8">
                            ...
                            <div class="form-group">
                                <label for="" class="control-label col-md-4">হিসাব ধরণ</label>
                                <div class="col-md-8">
                            ...
                            <div class="form-group">
                                <label for="" class="control-label col-md-4">ব্যাংকের নাম</label>
                                <div class="col-md-8">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="" class="control-label col-md-4">শাখার নাম</label>
                                <div class="col-md-8">
                            ...
                            <div class="form-group" style="display: none;">
                                <label for="" class="control-label col-md-4">প্রাথমিক ব্যালেন্স</label>
                                <div class="col-md-8">
                            ...
                            <div class="form-group">
                                <label for="" class="control-label col-md-4">বর্ণনা</label>
                                <div class="col-md-8">
    ...
    <div class="widget-box">
        <div class="widget-header">
            <h4 class="widget-title">হিসাব তালিকা</h4>
            <div class="widget-toolbar">
                <a href="#" data-action="collapse">
                    <i class="ace-icon fa fa-chevron-up"></i>
                </a>
    ...
    new Vue({
        ...
        data(){
            return {
                ...
                accounts: [],
                columns: [
                    { label: 'হিসাব নাম', field: 'account_name', align: 'center' },
                    { label: 'হিসাব নং', field: 'account_number', align: 'center' },
                    { label: 'হিসাব ধরণ', field: 'account_type', align: 'center' },
                    { label: 'ব্যাংকের নাম', field: 'bank_name', align: 'center' },
                    { label: 'শাখার নাম', field: 'branch_name', align: 'center' },
                    // { label: 'Initial Balance', field: 'initial_balance', align: 'center' },
                    { label: 'স্ট্যাটাস', field: 'status_text', align: 'center' },
        ...
        methods: {
            ...
            changeStatus(account){
                axios.post('/change_account_status', {account: account}).then(res => {
                    let r = res.data;
                    alert(r.message);
                    if(r.success){
                        this.getAccounts();
