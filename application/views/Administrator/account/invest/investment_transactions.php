...
<div id="bankTransactions">
    ...
    <div class="widget-box">
        <div class="widget-header">
            <h4 class="widget-title">লেনদেন তালিকা</h4>
            <div class="widget-toolbar">
                <a href="#" data-action="collapse">
                    <i class="ace-icon fa fa-chevron-up"></i>
                </a>
        ...
        data(){
            return {
                ...
                columns: [
                    ...
                    { label: 'হিসাব কোড', field: 'Acc_Code', align: 'center' },
                    { label: 'হিসাবের নাম', field: 'Acc_Name', align: 'center' },
                    { label: 'লেনদেন ধরণ', field: 'transaction_type', align: 'center' },
                    { label: 'নোট', field: 'note', align: 'center' },
                    { label: 'হিসাব', field: 'amount', align: 'center' },
