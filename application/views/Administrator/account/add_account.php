                    ...
                    <div class="row">
                        <div class="col-md-4 col-md-offset-3">
                            <div class="form-group">
                                <label class="control-label col-md-4">হিসাব আইডি</label>
                                <div class="col-md-8">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-4">হিসাব নাম</label>
                                <div class="col-md-8">
                            ...
                            <div class="form-group" style="display:none;">
                                <label class="control-label col-md-4">হিসাব ধরণ</label>
                                <div class="col-md-8">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-4">বর্ণনা</label>
                                <div class="col-md-8">
                            ...
                            <div class="form-group">
                                <div class="col-md-8 col-md-offset-4">
                                    <input type="submit" value="সেভ" class="btn btn-success">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    new Vue({
        ...
        data(){
            return {
                ...
                columns: [
                    { label: 'হিসাব আইডি', field: 'Acc_Code', align: 'center' },
                    { label: 'হিসাব নাম', field: 'Acc_Name', align: 'center' },
                    { label: 'বর্ণনা', field: 'Acc_Description', align: 'center' },
