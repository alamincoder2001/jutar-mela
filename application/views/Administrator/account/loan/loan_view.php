    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="balance-section">
                ...
                <h3>ঋণ ব্যালেন্স</h3>
                <?php $loan_balance = array_reduce($loan_account_summary, function($prev, $curr){ return $prev + $curr->balance;});?>
                <h1><?php echo $this->session->userdata('Currency_Name');?> <?php echo number_format($loan_balance, 2);?></h1>
            </div>
        </div>
    </div>

    <div class="row" style="margin-top: 25px;">
        <?php foreach($loan_account_summary as $account){?>
        <div class="col-md-3">
