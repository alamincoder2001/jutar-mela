...
<div id="loanAccounts">
    ...
    <div class="widget-box">
        <div class="widget-header">
            <h4 class="widget-title">হিসাবের তালিকা</h4>
            <div class="widget-toolbar">
                <a href="#" data-action="collapse">
                    <i class="ace-icon fa fa-chevron-up"></i>
                </a>
        ...
        data(){
            return {
                ...
                columns: [
                    ...
                    { label: 'হিসাবের নং', field: 'account_number', align: 'center' },
                    { label: 'হিসাবের ধরণ', field: 'account_type', align: 'center' },
                    { label: 'ব্যাংকের নাম', field: 'bank_name', align: 'center' },
                    { label: 'শাখার নাম', field: 'branch_name', align: 'center' },
                    { label: 'প্রাথমিক ব্যালেন্স', field: 'initial_balance', align: 'center' },
