...
<div class="col-xs-12">
	...
	<div class="form-horizontal">
		...
		<div class="form-group">
			<label class="col-sm-3 control-label no-padding-right" for="form-field-1">এলাকার নাম   </label>
			<label class="col-sm-1 control-label no-padding-right">:</label>
			<div class="col-sm-8">
				<input type="text" id="district" name="district" placeholder="এলাকার নাম" value="<?php echo set_value('district'); ?>" class="col-xs-10 col-sm-4" />
				<span id="msg"></span>
