...
<div id="quotation" class="row">
	<div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
		<div class="row">
			<div class="form-group">
				<label class="col-sm-1 control-label no-padding-right"> চালান নং </label>
				<div class="col-sm-2">
			...
			<div class="form-group">
				<label class="col-sm-1 control-label no-padding-right"> কোটে.বাই </label>
				<div class="col-sm-2">
			...
			<div class="form-group">
				<label class="col-sm-1 control-label no-padding-right"> কোটে. ফর্ম </label>
				<div class="col-sm-2">
	...
	<div class="col-xs-9 col-md-9 col-lg-9">
		<div class="widget-box">
			<div class="widget-header">
				<h4 class="widget-title">কোটেশন তথ্য</h4>
				...
				<div class="widget-main">
					...
					<div class="row">
						<div class="col-sm-5">
							...
							<div class="form-group">
								<label class="col-sm-4 control-label no-padding-right">মোবাইল নাম্বার</label>
								<div class="col-sm-8">
						...
						<div class="col-sm-5">
							<form v-on:submit.prevent="addToCart">
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right">পণ্য</label>
									<div class="col-sm-8">
								...
								<div class="form-group" style="display: none;">
									<label class="col-sm-3 control-label no-padding-right">ব্র্যান্ড</label>
									<div class="col-sm-9">
								...
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right">বিক্রয় হার</label>
									<div class="col-sm-9">
								...
								<div class="form-group" style="display:none;">
									<label class="col-sm-3 control-label no-padding-right"> ছাড়</label>
									<div class="col-sm-9">
										<span>(%)</span>
								...
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right">মোট</label>
									<div class="col-sm-9">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<button type="submit" class="btn btn-default pull-right">যোগ করুন</button>
									</div>
								</div>
							</form>
		...
		<div class="col-xs-12 col-md-12 col-lg-12" style="padding-left: 0px;padding-right: 0px;">
			<div class="table-responsive">
				<table class="table table-bordered" style="color:#000;margin-bottom: 5px;">
					<thead>
						<tr class="">
							<th style="width:10%;color:#000;">ক্রম</th>
							<th style="width:25%;color:#000;">ক্যাটাগরি</th>
							<th style="width:20%;color:#000;">পণ্যের নাম</th>
							<th style="width:7%;color:#000;">পরিমাণ</th>
							<th style="width:8%;color:#000;">হার</th>
							<th style="width:15%;color:#000;">সর্বমোট পরিমাণ</th>
							<th style="width:15%;color:#000;">কর্ম</th>
						</tr>
					</thead>
	...
	<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
		<div class="widget-box">
			<div class="widget-header">
				<h4 class="widget-title">পরিমাণের বিবরণ</h4>
				<div class="widget-toolbar">
					<a href="#" data-action="collapse">
						<i class="ace-icon fa fa-chevron-up"></i>
					</a>
							...
							<div class="table-responsive">
								<table style="color:#000;margin-bottom: 0px;border-collapse: collapse;">
									<tr>
										<td>
											<div class="form-group">
												<label class="col-sm-12 control-label no-padding-right">সর্বমোট</label>
												<div class="col-sm-12">
									...
									<tr>
										<td>
											<div class="form-group">
												<label class="col-sm-12 control-label no-padding-right"> ভ্যাট </label>
												<div class="col-sm-4">
									...
									<tr style="display:none;">
										<td>
											<div class="form-group">
												<label class="col-sm-12 control-label no-padding-right">যানবাহন খরচ</label>
												<div class="col-sm-12">
									...
									<tr>
										<td>
											<div class="form-group">
												<label class="col-sm-12 control-label no-padding-right">ছাড়
												</label>
									...
									<tr>
										<td>
											<div class="form-group">
												<label class="col-sm-12 control-label no-padding-right">মোট</label>
												<div class="col-sm-12">
									...
									<tr>
										<td>
											<div class="form-group">
												<div class="col-sm-3">
													<input type="button" class="btn btn-default" value="সেইভ" v-on:click="saveQuotation" style="color:#fff;margin-top: 0px;">
												</div>
												<div class="col-sm-4">
													<input type="button" class="btn btn-info" value="নতুন কোটেশন" v-on:click="window.location = '/quotation'" style="color:#fff;margin-top: 0px;">
												</div>
											</div>
										</td>
									</tr>
