...
<div id="graph">
    ...
    <div class="row" v-if="showData" style="display:none;" v-bind:style="{ display: showData ? '' : 'none' }">
        <div class="col-md-2  col-xs-6">
            <div class="widgets" style="border-top: 5px solid #1c8dff;">
                ...
                <div class="widget-content">
                    <div class="widget-text">আজকের বিক্রয়</div>
        ...
        <div class="col-md-2  col-xs-6">
            <div class="widgets" style="border-top: 5px solid #666633;">
                ...
                <div class="widget-content">
                    <div class="widget-text">সংগ্রহ</div>
        ...
        <div class="col-md-2  col-xs-6">
            <div class="widgets" style="border-top: 5px solid #008241;">
                ...
                <div class="widget-content">
                    <div class="widget-text">মাসিক বিক্রয়</div>
        ...
        <div class="col-md-2  col-xs-6">
            <div class="widgets" style="border-top: 5px solid #ff8000;">
                ...
                <div class="widget-content">
                    <div class="widget-text">ক্রেতা বাকি</div>
        ...
        <div class="col-md-2  col-xs-6">
            <div class="widgets" style="border-top: 5px solid #ae0000;">
                ...
                <div class="widget-content">
                    <div class="widget-text">ক্যাশ ব্যালেন্স</div>
        ...
        <div class="col-md-2  col-xs-6">
            <div class="widgets" style="border-top: 5px solid #663300;">
                ...
                <div class="widget-content">
                    <div class="widget-text">ব্যাংক ব্যালেন্স</div>
    ...
    <div class="row" v-if="showData" style="display:none;margin-top: 10px;" v-bind:style="{ display: showData ? '' : 'none' }">
        <div class="col-md-2  col-xs-6">
            <div class="widgets" style="border-top: 5px solid #1c8dff;">
                ...
                <div class="widget-content">
                    <div class="widget-text">স্টক মূল্য</div>
        ...
        <div class="col-md-2  col-xs-6">
            <div class="widgets" style="border-top: 5px solid #666633;">
                ...
                <div class="widget-content">
                    <div class="widget-text">সম্পত্তির মূল্য</div>
        ...
        <div class="col-md-2  col-xs-6">
            <div class="widgets" style="border-top: 5px solid #008241;">
                ...
                <div class="widget-content">
                    <div class="widget-text">সাপ্লায়ার বাকি</div>
        ...
        <div class="col-md-2  col-xs-6">
            <div class="widgets" style="border-top: 5px solid #ff8000;">
                ...
                <div class="widget-content">
                    <div class="widget-text"> বিনিয়োগ ব্যালেন্স</div>
        ...
        <div class="col-md-2  col-xs-6">
            <div class="widgets" style="border-top: 5px solid #ae0000;">
                ...
                <div class="widget-content">
                    <div class="widget-text">ঋণ  ব্যালেন্স</div>
        ...
        <div class="col-md-2  col-xs-6">
            <div class="widgets" style="border-top: 5px solid #663300;">
                ...
                <div class="widget-content">
                    <div class="widget-text">মাসিক লাভ</div>
    ...
    <div class="row" style="margin-top:20px;margin-bottom: 25px;">
        ...
        <div class="col-md-12" v-if="salesGraph == 'monthly'">
            <h3 class="text-center">এই মাসের বিক্রয়</h3>
            <sales-chart
            type="ColumnChart"
            :data="salesData"
        ...
        <div class="col-md-12" v-else>
            <h3 class="text-center">এই বছরের বিক্রয়</h3>
            <sales-chart
            type="ColumnChart"
    ...
    <div class="row">
        <div class="col-md-6">
            <h3 class="text-center">শীর্ষ বিক্রি পণ্য</h3>
            <top-product-chart
            type="PieChart"
            :data="topProducts"
        ...
        <div class="col-md-4 col-md-offset-2">
            <table class="table custom-table-bordered">
                <thead>
                    <tr>
                        <td class="text-center" colspan="2" style="background-color: #224079;color: white;font-weight: 900;">শীর্ষ গ্রাহক</td>
                    </tr>
                </thead>
                <tbody>
