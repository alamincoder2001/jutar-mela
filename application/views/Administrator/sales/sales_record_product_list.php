...
<div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;">
	<div class="form-group" style="margin-top:10px;">
		<label class="col-sm-1 control-label no-padding-right" for="customerID"> সার্চ টাইপ  </label>
		<div class="col-sm-3">
		...
		<div class="form-group">
			<label class="col-sm-1 control-label no-padding-right" for="Sales_startdate"> তারিখ হতে  </label>
		</div>
		...
		<div class="form-group">
			<label class="col-sm-1 control-label no-padding-right" for="Sales_enddate"> তারিখ থেকে </label>
		</div> 
	...
	<div class="form-group">
		<div class="col-sm-2">
			<input type="button" class="btn btn-primary form-control" onclick="Customerdata()" value="রিপোর্ট দেখুন" style="margin-top:0px;border:0px;height:28px;width:100%;">
		</div>
	</div>
</div>
