		...
		<div class="row" style="margin-top: 10px;margin-bottom:15px;border-bottom: 1px solid #ccc;padding-bottom:15px;">
			<div class="col-md-5">
				<div class="form-group clearfix">
					<label class="control-label col-md-4">ক্রেতার আইডি:</label>
					<div class="col-md-7">
				...
				<div class="form-group clearfix">
					<label class="control-label col-md-4">ক্রেতার নাম:</label>
					<div class="col-md-7">
				...
				<div class="form-group clearfix">
					<label class="control-label col-md-4">এলাকা:</label>
					<div class="col-md-7">
			...
			<div class="col-md-5">
				...
				<div class="form-group clearfix">
					<label class="control-label col-md-4">অফিস ফোন:</label>
					<div class="col-md-7">
				...
				<div class="form-group clearfix">
					<label class="control-label col-md-4">ক্রেডিট সীমা:</label>
					<div class="col-md-7">
				...
				<div class="form-group clearfix">
					<label class="control-label col-md-4">ক্রেতা ধরণ:</label>
					<div class="col-md-7">
	...
	new Vue({
		...
		methods: {
			...
			saveCustomer() {
				...
				// 	return;
				// }
				this.customer.area_ID = this.selectedDistrict != null ? this.selectedDistrict.District_SlNo : null;
