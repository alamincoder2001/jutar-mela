		...
		<div class="row" style="padding-top:10px;">
			<div class="col-md-6">
				...
				<table class="table table-bordered table-condensed">
					<thead>
						<tr style="background: #dee4dc;">
							<th colspan="4">ক্রেতাদের কাছ থেকে প্রাপ্ত</th>
						</tr>
						<tr>
							<th>চালান</th>
							<th>তারিখ</th>
				...
				<table class="table table-bordered table-condensed">
					<thead>
						<tr style="background: #dee4dc;">
							<th colspan="4">সাপ্লায়ার কাছ থেকে প্রাপ্ত</th>
						</tr>
						<tr>
							<th>চালান</th> 
							<th>তারিখ</th>
				...
				<table class="table table-bordered table-condensed">
					<thead>
						<tr style="background: #dee4dc;">
							<th colspan="6">ব্যাংক উত্তোলন</th>
						</tr>
						<tr>
							<th>নং</th>
							<th>হিসাব নাম </th>
				...
				<table class="table table-bordered table-condensed">
					<thead>
						<tr style="background: #dee4dc;">
							<th colspan="5">প্রাপ্ত বিনিয়োগ</th>
						</tr>
						<tr>
				...
				<table class="table table-bordered table-condensed">
					<thead>
						<tr style="background: #dee4dc;">
							<th colspan="4">সম্পদের বিক্রয়</th>
						</tr>
						<tr>
							<th>নং</th>
							<th>সম্পদের নাম</th>
			...
			<div class="col-md-6">
				...
				<table class="table table-bordered table-condensed">
					<thead>
						<tr style="background: #dee4dc;">
							<th colspan="4">সাপ্লায়ারকে অর্থ পরিশোধ</th>
						</tr>
						<tr>
							<th>চালান</th>
							<th>তারিখ</th>
				...
				<table class="table table-bordered table-condensed">
					...
					<tbody style="display:none;" v-bind:style="{display: productReturns.length > 0 ? '' : 'none'}">
						<tr v-for="payment in productReturns">
							<td>{{ payment.ReturnDate }}</td>
							<td>{{ payment.Customer_Name }}</td>
							<td>{{ payment.Product_Name }}</td>
							<td style="text-align:right;">{{ payment.ReturnAmount | decimal }}</td>
						</tr>
					</tbody>
					<tfoot>
						<tr style="font-weight:bold;">
							<td colspan="3" style="text-align:right;">মোট</td>
							<td style="text-align:right;">
								<span v-if="productReturns.length == 0">0.00</span>
								<span v-else>{{ totalProductReturns | decimal }}</span>
							</td>
						</tr>
					</tfoot>
				</table>
				...
				<table class="table table-bordered table-condensed">
					<thead>
						<tr style="background: #dee4dc;">
							<th colspan="5">বিনিয়োগ পেমেন্ট</th>
						</tr>
						<tr>
							<th>নং</th>
							<th>হিসাব কোড</th>
				...
				<table class="table table-bordered table-condensed">
					<thead>
						<tr style="background: #dee4dc;">
							<th colspan="5">কর্মচারী পেমেন্ট</th>
						</tr>
						<tr>
							<th>কর্মচারী আইডি </th>
							<th>কর্মচারী নাম</th>
	...
	new Vue({
		...
		methods: {
			...
			getProductReturns() {
				...
				axios.post('/get_product_return', filter)
					.then(res => {
