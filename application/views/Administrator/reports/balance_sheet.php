					...
					<table class="balancesheet-table">
						...
						<tbody>
							...
							<tr :style="{display: supplier_prev_due != 0 ? '' : 'none'}">
								<th>সাপ্লায়ার পূর্বের বাকি সামঞ্জস্য</th>
						...
						<tfoot>
							<tr>
								<th style="text-align:right;">মোট সম্পদ</th>
					...
					<table class="balancesheet-table">
						...
						<tbody>
							...
							<tr :style="{display: customer_prev_due != 0 ? '' : 'none'}">
								<th>ক্রেতার পূর্ববর্তী বাকি সমন্বয়</th>
						...
						<tfoot>
							<tr>
								<th style="text-align:right;">মোট দায়</th>
