        ...
        <div class="col-sm-12">
            ...
            <div class="table-responsive" id="reportTable">
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            <th style="text-align:center">লেনদেন নং</th>
                            <th style="text-align:center">তারিখ</th>
                            <th style="text-align:center">ক্রেতা</th>
                            <th style="text-align:center">লেনদেন ধরণ</th>
                            <th style="text-align:center">পেমেন্ট বাই</th>
