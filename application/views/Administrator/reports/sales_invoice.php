...
<?php if($row->print_type == 3) { ?>
      ...
      <table width="270" >
       <tr>
        ...
        <tr>
            <td colspan="2" style="background:#ddd;" align="center"><strong style="font-size:16px;">বিক্রয় ভাউচার</strong></td>
        </tr>
...
<div style="width: 480px; height: 107px; margin: auto; margin-left:-0px; ">
    ...
    <table  cellspacing="0" cellpadding="0" width="480">
        <tr>
             <td colspan="2" style="background:#ddd; padding: 3px 0;" " align="center"><strong style="font-size:16px;">বিক্রয় ভাউচার</strong></td>
        </tr>
        <tr>
            <td>
...
<?php }elseif($row->print_type == 1){ ?>
	...
	<table  cellspacing="0" cellpadding="0" width="90%">
        <tr>
            <td colspan="2" style="background:#ddd; padding: 5px 0;" align="center"><strong style="font-size:18px;">বিক্রয় ভাউচার</strong></td>
        </tr>
        <tr>
            <td>
