			...
			<div class="row" style="margin-top:15px;">
				<div class="col-xs-6">
					<table class="balancesheet-table">
						...
						<tfoot>
							<tr>
								<td style="text-align:right;">মোট ক্যাশ ইন</td>
				...
				<div class="col-xs-6">
					<table class="balancesheet-table">
						...
						<tbody>
							...
							<tr>
								<td>সাপ্লায়ার পেমেন্ট পরিশোধ</td>
								<td style="text-align:right;">{{ totalPaidToSuppliers | decimal }}</td>
							</tr>
							<tr>
								<td>পণ্য ফেরত</td>
								<td style="text-align:right;">{{ totalProductReturns | decimal }}</td>
							</tr>
							<tr>
								<td>ক্যাশ পরিশোধ</td>
						...
						<tfoot>
							<tr>
								<td style="text-align:right;">মোট ক্যাশ আউট</td>
			...
			<div class="row" style="margin-top: 15px;">
				<div class="col-xs-12">
					<div style="padding:5px;background-color:#e27a07;text-align:center;color:white;">
						<h4>ক্যাশ ব্যালেন্স : {{ cashBalance | decimal }}</h4>
					</div>
				</div>
			</div>
	...
	new Vue({
		...
		methods: {
			async getStatements() {
				...
				await this.getProductReturns();
				this.showReport = true;
			},

			async getProductReturns() {
				await axios.post('/get_product_return', this.filter)
					.then(res => {
