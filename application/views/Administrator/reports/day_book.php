				...
				<div style="display:flex;">
					<div style="width:50%;border:1px solid black;position:relative;">
						<table class="day-book-table">
							...
							<tbody>
								<tr>
									<td class="main-heading">ওপেনিং ব্যালেন্স</td>
									<td></td>
								</tr>
								<template v-if="openingBalance.cashBalance != null">
									<tr>
										<td class="sub-heading">হাতে নগদ</td>
								...
								<template v-if="openingBalance.bankBalance.length > 0">
									<tr>
										<td class="sub-heading">ব্যাংক হিসাব</td>
								...
								<tr>
									<td class="main-heading">প্রাপ্তি</td>
									<td></td>
								</tr>
								<template v-if="sales.length > 0">
									<tr>
										<td class="sub-heading">বিক্রয়</td>
								...
								<template v-if="asset_sales.length > 0">
									<tr>
										<td class="sub-heading">সম্পদ বিক্রয়</td>
								...
								<template v-if="receivedFromCustomers.length > 0">
									<tr>
										<td class="sub-heading">ক্রেতার পেমেন্ট</td>
								...
								<template v-if="cashReceived.length > 0">
									<tr>
										<td class="sub-heading">ক্যাশ গ্রহন</td>
								...
								<template v-if="receivedFromSuppliers.length > 0">
									<tr>
										<td class="sub-heading">সাপ্লায়ার হতে গ্রহন</td>
								...
								<template v-if="loanInitials.length > 0">
									<tr>
										<td class="sub-heading">ঋণের প্রাথমিক ব্যালেন্স</span></td>
								...
								<template v-if="loanReceives.length > 0">
									<tr>
										<td class="sub-heading">ঋণ গ্রহণ</span></td>
								...
								<template v-if="investReceives.length > 0">
									<tr>
										<td class="sub-heading">বিনিয়োগ গ্রহন</span></td>
								...
								<template v-if="bankWithdraws.length > 0">
									<tr>
										<td class="sub-heading">ব্যাংক উত্তোলন <span style="color:red;">(Not Calculated)</span></td>
								...
								<template v-if="bankDeposits.length > 0">
									<tr>
										<td class="sub-heading">ব্যাংক জমা<span style="color:red;">(Not Calculated)</span></td>
					...
					<div style="width:50%;border:1px solid black;border-left:none;position:relative;">
						<table class="day-book-table">
							...
							<tbody>
								<tr>
									<td class="main-heading">পেমেন্ট</td>
									<td></td>
								</tr>
								<template v-if="purchases.length > 0">
									<tr>
										<td class="sub-heading">ক্রয়</td>
								...
								<template v-if="asset_purchases.length > 0">
									<tr>
										<td class="sub-heading">সম্পদ ক্রয়</td>
								...
								<template v-if="paidToSuppliers.length > 0">
									<tr>
										<td class="sub-heading">সাপ্লায়ার পেমেন্ট</td>
								...
								<template v-if="productReturns.length > 0">
									<tr>
										<td class="sub-heading">পণ্য ফেরত পরিশোধ </td>
										<td class="sub-value">{{ totalProductReturns }}</td>
									</tr>
									<tr v-for="item in productReturns">
										<td>{{ item.Product_Name }}</td>
										<td>{{ item.ReturnAmount | decimal }}</td>
									</tr>
								</template>
								...
								<template v-if="cashPaid.length > 0">
									<tr>
										<td class="sub-heading">ক্যাশ পরিশোধ</td>
								...
								<template v-if="paidToCustomers.length > 0">
									<tr>
										<td class="sub-heading">ক্রেতাদের পরিশোধ</td>
								...
								<template v-if="employeePayments.length > 0">
									<tr>
										<td class="sub-heading">কর্মচারী পেমেন্ট</td>
								...
								<template v-if="loanPayments.length > 0">
									<tr>
										<td class="sub-heading">ঋণ পরিশোধ</span></td>
								...
								<template v-if="investPayments.length > 0">
									<tr>
										<td class="sub-heading">পেমেন্ট বিনিয়োগ </span></td>
								...
								<tr>
									<td class="main-heading">শেষ ব্যালেন্স</td>
									<td></td>
								</tr>
...
<script>
	new Vue({
		...
		computed: {
			...
			totalProductReturns() {
				return this.productReturns.reduce((prev, curr) => {
					return prev + parseFloat(curr.ReturnAmount)
				}, 0).toFixed(2);
			},
			totalIn() {
			...
			totalOut() {
				return parseFloat(this.totalPurchase) +
					...
					parseFloat(this.totalProductReturns) +
		...
		methods: {
			getDayBookData() {
				...
				this.getProductReturns();
			},

			getProductReturns() {
				axios.post('/get_product_return', this.filter)
					.then(res => {
						this.productReturns = res.data;
					})
			},
