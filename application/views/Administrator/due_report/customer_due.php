...
<div class="row" id="customerDueList">
	<div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;">
		<div class="form-group">
			<label class="col-sm-1 control-label no-padding-right">সার্চ টাইপ</label>
			<div class="col-sm-2">
		...
		<div class="form-group" style="display: none" v-bind:style="{display: searchType == 'customer' ? '' : 'none'}">
			<label class="col-sm-2 control-label no-padding-right">গ্রাহক নির্বাচন</label>
			<div class="col-sm-2">
		...
		<div class="form-group" style="display: none" v-bind:style="{display: searchType == 'area' ? '' : 'none'}">
			<label class="col-sm-1 control-label no-padding-right">এলাকা নির্বাচন</label>
			<div class="col-sm-2">
		...
		<div class="form-group">
			<div class="col-sm-2">
				<input type="button" class="btn btn-primary" value="রিপোর্ট দেখান" v-on:click="getDues" style="margin-top:0px;border:0px;height:28px;">
			</div>
		</div>
	</div>
			...
			<table class="table table-bordered">
				...
				<tfoot>
					<tr style="font-weight:bold;">
						<td colspan="5" style="text-align:right">মোট বাকি</td>
