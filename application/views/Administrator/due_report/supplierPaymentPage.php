				...
				<div class="row">
					<div class="col-md-5 col-md-offset-1">
						<div class="form-group">
							<label class="col-md-4 control-label">লেনদেনের ধরন</label>
						...
						<div class="form-group">
							<label class="col-md-4 control-label">অর্থপ্রদানের ধরন</label>
							<label class="col-md-1">:</label>
							<div class="col-md-7">
						...
						<div class="form-group" style="display:none;" v-bind:style="{display: payment.SPayment_Paymentby == 'bank' ? '' : 'none'}">
							<label class="col-md-4 control-label">ব্যাংক হিসাব</label>
							<label class="col-md-1">:</label>
							<div class="col-md-7">
						...
						<div class="form-group">
							<label class="col-md-4 control-label">সরবরাহকারী</label>
							<label class="col-md-1">:</label>
						...
						<div class="form-group">
							<label class="col-md-4 control-label">বকেয়া</label>
							<label class="col-md-1">:</label>
							<div class="col-md-7">
					...
					<div class="col-md-5">
						<div class="form-group">
							<label class="col-md-4 control-label">অর্থপ্রদানের তারিখ</label>
							<label class="col-md-1">:</label>
							<div class="col-md-7">
						...
						<div class="form-group">
							<label class="col-md-4 control-label">টাকার পরিমাণ</label>
							<label class="col-md-1">:</label>
							<div class="col-md-7">
