...
<div class="col-xs-12">
	...
	<div class="col-sm-6">
		<div class="form-group">
			<label class="col-sm-4 control-label" for="txtFirstName"> পুরো নাম </label>
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" name="txtFirstName" id="txtFirstName" placeholder="পুরো নাম" value="" class="form-control" />
			</div>
		</div>
		
	<div class="form-group">
			<label class="col-sm-4 control-label" for="user_email"> ইউজার ই-মেইল </label>
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
		...
		<!-- <div class="form-group">
			<label class="col-sm-4 control-label" for="Brunch"> শাখা নির্বাচন করুন </label>
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
		...
		<div class="form-group">
			<label class="col-sm-4 control-label" for="type"> ইউজার ধরণ </label>
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
	...
	<div class="col-sm-6">
		<div class="form-group">
			<label class="col-sm-4 control-label" for="username"> ইউজার নাম </label>
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
		...
		<div class="form-group">
			<label class="col-sm-4 control-label" for="Password"> পাসওয়ার্ড </label>
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
		...
		<div class="form-group">
			<label class="col-sm-4 control-label" for="rePassword"> পুনঃ পাসওয়ার্ড </label>
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
	...
	<table id="dynamic-table" class="table table-striped table-bordered table-hover">
		<thead>
			<tr>
				<th>নাম</th>
				<th>শাখা</th>
				<th class="hidden-480">ইউজার নাম</th>
				<th>ইউজার ই-মেইল</th>
				<th>ধরণ</th>
				<th>স্ট্যাটাস</th>
				<th>কর্ম</th>
