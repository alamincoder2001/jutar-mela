					...
					?>
							...
							<div style="padding: 2px; float: left; height: 102.5px; width: 135px; border: 1px solid #ddd;">
								<div style="width: 135px; text-align: center; float: right;">
									<p class="article" style="font-size: 12px;margin: 0px;"><?php echo $article; ?></p>
									<p style="font-size: 12px; text-align: center;margin: 0px;"><?php echo $pname; ?></p>
									<img src='<?php echo base_url(); ?>GenerateBarcode/<?php echo $PID; ?>' style="height: 45px; width: 110px;" />
									<p style="font-size:10px; text-align: center;margin: 0px;"><?php echo $PID; ?></p>
									<p style="text-align: center;margin: -4px 0 0 0px;">'MRP' . ' ' . $Price; ?></p>
								</div>
							</div>
					<?php
						}
