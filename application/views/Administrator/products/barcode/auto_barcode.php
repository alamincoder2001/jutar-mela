				...
				<form class="form-horizontal" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post">
					<section class="" id="printButton" style="background:#f4f4f4;height:200px;">
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<input type="text" name="article" class="form-control mytext" placeholder="Article ..." value="<?php echo $product->Product_Article; ?>" />
							</div>
							<div class="col-sm-2">
				...
				<section class="output" style="margin:0px;padding:0px;">
					...
					?>
							...
							<div class="borderNonePirint" style="float:left;margin:0px;padding:5px; height:135px; width:200px;overflow:hidden;box-sizing:border-box;">
								<div style="width: 190px; height:115px;text-align: center;margin:0;padding:10px 0px 0px 0px;">
									...
									<p style="margin:-20px 0 0 0;width:20px;font-size: 16px;float:left;writing-mode: tb-rl;font-weight:700;height:100px"><?php echo $article; ?></p>
									<img src='<?php echo site_url(); ?>GenerateBarcode/<?php echo $PID; ?>' style="height: 55px; width: 160px;" />
									<p style="font-size:13px; text-align: center;margin: 0px;"><?php echo $PID; ?></p>
									<p style="font-weight: bold;margin: 0 auto;width:100px;font-size: 16px;"><?php echo 'MRP ' . $Price; ?></p>
								</div>
							</div>
					<?php
						}
