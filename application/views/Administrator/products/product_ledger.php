	...
	<div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;">
		<form v-on:submit.prevent="getProductLedger">
			<div class="form-group">
				<label class="col-sm-1 control-label no-padding-right">পণ্য</label>
				<div class="col-sm-2">
			...
			<div class="form-group">
				<div class="col-sm-1">
					<input type="submit" class="btn btn-primary" value="দেখুন" style="margin-top:0px;border:0px;height:28px;">
				</div>
			</div>
		</form>
	</div>
			...
			<table class="table table-bordered">
				<thead>
					<tr>
						...
						<th style="text-align:center">ইন পরিমাণ</th>
						<th style="text-align:center">আউট পরিমাণ</th>
				...
				<tbody>
					<tr>
						<td></td>
						<td style="text-align:left;">পূর্বের স্টক </td>
						<td colspan="3"></td>
				...
				<tbody v-if="ledger.length == 0">
					<tr>
						<td colspan="6">কোন রেকর্ড পাওয়া যায়নি</td>
					</tr>
				</tbody>
			</table>
		</div>
