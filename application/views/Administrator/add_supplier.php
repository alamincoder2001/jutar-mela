		...
		<div class="row" style="margin-top: 10px;margin-bottom:15px;border-bottom: 1px solid #ccc;padding-bottom:15px;">
			<div class="col-md-5">
				<div class="form-group clearfix">
					<label class="control-label col-md-4">সাপ্লায়ার আইডি:</label>
					<div class="col-md-7">
				...
				<div class="form-group clearfix">
					<label class="control-label col-md-4">সাপ্লায়ার নাম:</label>
					<div class="col-md-7">
				...
				<div class="form-group clearfix">
					<label class="control-label col-md-4">মালিকের নাম:</label>
					<div class="col-md-7">
			...
			<div class="col-md-5">
				<div class="form-group clearfix">
					<label class="control-label col-md-4">ফোন:</label>
					<div class="col-md-7">
				...
				<div class="form-group clearfix">
					<label class="control-label col-md-4">পূর্বের বাকি:</label>
					<div class="col-md-7">
	...
	new Vue({
		...
		data(){
			return {
				...
				columns: [
                    { label: 'সাপ্লায়ার আইডি', field: 'Supplier_Code', align: 'center', filterable: false },
                    { label: 'সাপ্লায়ার নাম', field: 'Supplier_Name', align: 'center' },
                    { label: 'যোগাযোগের ব্যক্তি', field: 'contact_person', align: 'center' },
                    { label: 'ঠিকানা', field: 'Supplier_Address', align: 'center' },
                    { label: 'যোগাযোগের নম্বর', field: 'Supplier_Mobile', align: 'center' },
