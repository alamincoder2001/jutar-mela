const salesInvoiceAuto = Vue.component("sales-invoice-auto", {
  template: `
        <div>
            <div class="row">
                <div class="col-xs-12">
            ...
            <div id="invoiceContent">
                ...
                <div class="row">
                    <div class="col-xs-7">
                        <strong>কাস্টমার Id:</strong> {{ sales.Customer_Code }}<br>
                        <strong>কাস্টমার নাম:</strong> {{ sales.Customer_Name }}<br>
                        <strong>কাস্টমার ঠিকানা:</strong> {{ sales.Customer_Address }}<br>
                        <strong>কাস্টমার মোবাইল:</strong> {{ sales.Customer_Mobile }}
                    </div>
                    <div class="col-xs-5 text-right">
                        <strong>সেল বাই:</strong> {{ sales.Employee_Name }}<br>
                        <strong>ইনভয়েস:</strong> {{ sales.SaleMaster_InvoiceNo }}<br>
                        <strong>তারিখ:</strong> {{ sales.SaleMaster_SaleDate }} {{ sales.AddTime | formatDateTime('h:mm a') }}
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <table _a584de>
                            ...
                            <tbody>
                                <tr v-for="(product, sl) in cart">
                                    ...
                                    <td align="center">{{ ((parseFloat(product.SaleDetails_Discount)*100)/parseFloat(product.SaleDetails_Rate)).toFixed(2) }}</td>
                                    <td align="center">{{ (product.SaleDetails_Rate - product.SaleDetails_Discount).toFixed(2) }}</td>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6">
                        <table _t92sadbc2>
                            ...
                            <tr>
                                <td><strong>ডিস্কাউন্ট %:</strong></td>
                                <td style="text-align:right">{{ sales.SaleMaster_TotalDiscountAmount }}</td>
                            </tr>

                           <!-- <tr>
                                <td><strong>পরিবহণ খরচ:</strong></td>
                                <td style="text-align:right">{{ sales.SaleMaster_Freight }}</td>
                            </tr> -->

                            <tr><td colspan="2" style="border-bottom: 1px solid #ccc"></td></tr>
                            <tr>
                                <td><strong>সর্ব মোট:</strong></td>
                                <td style="text-align:right">{{ sales.SaleMaster_TotalSaleAmount }}</td>
                            </tr>
                            <tr>
                                <td><strong>জমা/আদায়:</strong></td>
                                <td style="text-align:right">{{ (+sales.SaleMaster_PaidAmount + +sales.SaleMaster_ReturnAmount).toFixed(2) }}</td>
                            </tr>
                            <tr><td colspan="2" style="border-bottom: 1px solid #ccc"></td></tr>
                            <tr>
                                <td><strong>ফেরত/বকেয়া:</strong></td>
                ...
                <div class="row">
                    <div class="col-xs-12">
                       ...
                       <!-- <strong>Note: </strong> -->
                        <p style="white-space: pre-line;text-align:center">{{ companyProfile.invoice_note }}</p>
                    </div>
                </div>
            </div>
        </div>
