    ...
    template: `
        <div>
            ...
            <div id="invoiceContent">
                ...
                <div class="row">
                    <div class="col-xs-8">
                        <strong>ক্রেতার নাম:</strong> {{ quotation.SaleMaster_customer_name }}<br>
                        <strong>ক্রেতার ঠিকানা:</strong> {{ quotation.SaleMaster_customer_address }}<br>
                        <strong>ক্রেতার মোবাইল :</strong> {{ quotation.SaleMaster_customer_mobile }}
                    </div>
                    <div class="col-xs-4 text-right">
                        <strong> ক্রিয়েটেড বাইঃ</strong> {{ quotation.AddBy }}<br>
                        <strong>চালান নং:</strong> {{ quotation.SaleMaster_InvoiceNo }}<br>
                        <strong>তারিখ:</strong> {{ quotation.SaleMaster_SaleDate }} {{ moment(quotation.AddTime).format('h:mm a') }}
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
